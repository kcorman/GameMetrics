...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { actions: @level.actions, data: @level.data, session_id: @level.session_id, version: @level.version }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { actions: @level.actions, data: @level.data, session_id: @level.session_id, version: @level.version }
    assert_redirected_to level_path(assigns(:level))
  end
